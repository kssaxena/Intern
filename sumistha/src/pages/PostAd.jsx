    ...
    <div className="bg-gray-50 min-h-screen py-10">
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow p-8">
        ...
        <div className="relative flex items-center justify-between mb-10">
          ...
          {/* GREEN FILL LINE */}
          <div
            className="absolute top-1/2 left-0 h-[3px] bg-[#0aa78f] -translate-y-1/2 transition-all duration-500"
            style={{
        ...
        {step === 3 && (
          <section className="mb-8">
            ...
            <div className="border-2 border-dashed rounded-lg p-8 text-center text-sm text-gray-600">
              <div className="text-[#0aa78f] text-2xl mb-2">☁️</div>
        ...
        <div className="flex justify-between mt-10">
          ...
          {step < steps.length ? (
            <button
              onClick={() => setStep(step + 1)}
              className="bg-[#0aa78f] text-white px-6 py-2 rounded-md text-sm"
            >
              Next
            </button>
          ) : (
            <button className="bg-[#0aa78f] text-white px-6 py-2 rounded-md text-sm">
              Post My Ad
            </button>
          )}
        </div>
