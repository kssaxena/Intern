...
export default function SafetyTips() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen px-10 py-12">

      {/* HEADER */}
      <div className="max-w-6xl mx-auto mb-10">

        <h1 className="text-3xl font-bold">
          Your Safety is Our <span className="text-[#0aa78f]">Priority</span>.
        </h1>
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6">
        ...
        <div className="bg-[#1e293b] text-white p-6 rounded-xl shadow-sm">
          ...
          <Link to="/contact">
            <button className="bg-[#0aa78f] px-4 py-2 rounded-md text-sm font-medium hover:bg-[#099b85] transition">
             Report an Issue
            </button>
        </Link>
